...
");
        ...
        public void Extract(string[] parameters)
        {
            try
            {
                ParametersProcessor tester = new ParametersProcessor();
                ...
                try
                {
                    additionalArgs = p.Parse(parameters);
                }
        ...
        private ProcessingSettings buildSettings(string language,
        ...
        private TextFieldProcessingSettings buildTextFieldSettings(string language, string customOptions)
        {
